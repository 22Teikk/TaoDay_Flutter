                  ...
                  DraggableScrollableSheet(
                    ...
                    builder: (BuildContext context, scrollSheetController) {
                      return Obx(
                            ...
                            Container(
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.only(topRight: Radius.circular(8.0.wp), topLeft: Radius.circular(8.0.wp)),
                                color: Colors.white
                              ),
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (controller.isMaxSize.value == true) const SizedBox(
                                    height: 15,
                                  ),
                                  Container(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemBuilder: (BuildContext context,
                                        ...
                                        if (index == 0) {
                                          ...
                                          return UserItem(
                                            user: controller.listUser[index -
                                                1],
                                            controller: controller,
                                          );
                                        }
