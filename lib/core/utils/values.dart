...
const contentPermissionThree =
    '''The Stop battery optimization permission ensures that the app continues to run in the background, it's necessary for:
...
const contentPermissionFour =
    '''Enable the app to run in the background and autostart to to access your current location. This is necessary for the app:
• To share your location with your friend.
• In emergency cases, the app can send SOS alerts immediately with your location to friends.''';
const alertLogin =
